...
class _$News extends News {
  ...
  _$News._({this.data}) : super._() {
    if (data == null) {
      throw new BuiltValueNullFieldError('News', 'data');
    }
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is News && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('News')..add('data', data)).toString();
  }
}
...
class NewsBuilder implements Builder<News, NewsBuilder> {
  ...
  _$News build() {
    _$News _$result;
    try {
      _$result = _$v ?? new _$News._(data: data.build());
    } catch (_) {
